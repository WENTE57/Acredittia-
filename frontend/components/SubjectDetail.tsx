    ...
    <div className="flex flex-wrap items-center gap-2 border-b border-slate-100 px-4 py-3 last:border-0">
      ...
      {doc.ejemplo_clave && (
        <button
          ...
          onClick={() => onEjemplo(doc.ejemplo_clave!)}
        >
          Ver ejemplo
        </button>
      )}
          ...
          <div className="flex flex-wrap items-center gap-3 border-b border-slate-200 px-4 py-3">
            ...
            {data.licencia_interna.numero && (
              <span className="text-xs text-slate-500">
                {data.licencia_interna.numero} · vence{" "}
                {data.licencia_interna.vence ?? "—"}
              </span>
            )}
          </div>
